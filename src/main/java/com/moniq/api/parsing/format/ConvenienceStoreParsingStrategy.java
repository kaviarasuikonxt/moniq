...
@Component
public class ConvenienceStoreParsingStrategy implements ReceiptParsingStrategy {
    ...
    public String buildParserInput(ReceiptParsingInput input) {
        String layoutPreferred = filterConvenienceSection(input.getLayoutText());
        String rawFallback = filterConvenienceSection(input.getRawText());
    ...
    private String filterConvenienceSection(String text) {
